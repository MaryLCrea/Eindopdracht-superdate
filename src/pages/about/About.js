    ...
    return (
        <>
            ...
            <div className="inner-page-container pages">
                <h4 >Over ons</h4>
            <section className="text">Superdate is een van de grootste online datingsites in Europa voor singles die op zoek zijn naar een serieuze relatie.</section>
               ...
               Indien je een e–mail wil sturen, gebruik dan het contactformulier.
                ...
                Heb je een vraag over het gebruik van Superdate, stuur dan een e-mail naar: klantenservice@superdate.nl.
</section>
